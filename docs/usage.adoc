...
[source,css]
----
include::../src/main/resources/static/my-extension/styles.css[]
----
+
...
+
. *Place the login page and its stylesheet under `src/main/resources/static/idprovider/`* — the static-asset folder the controller's `root` option points at:
+
.src/main/resources/static/idprovider/index.html
[source,html]
----
include::../src/main/resources/static/idprovider/index.html[]
----
+
.src/main/resources/static/idprovider/login.css
[source,css]
----
include::../src/main/resources/static/idprovider/login.css[]
----
+
