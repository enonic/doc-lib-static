...
. *Define the extension descriptor.* The extension is mounted by XP at a URL like `/_/admin:extension/com.example.static:my-extension`.
+
.src/main/resources/admin/extensions/my-extension/my-extension.yaml
[source,yaml]
----
include::../src/main/resources/admin/extensions/my-extension/my-extension.yaml[]
----
+
...
+
.src/main/resources/admin/extensions/my-extension/files/styles.css
[source,css]
----
include::../src/main/resources/admin/extensions/my-extension/files/styles.css[]
----
+
